...
public class UserProfileMicropostAdapter extends ArrayAdapter<Micropost> {
	private final Context context;
	private final ArrayList<Micropost> values;

	public UserProfileMicropostAdapter(Context context, ArrayList<Micropost> values) {
		super(context, R.layout.user_profile_micropost_row_layout, values);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (rowView == null) {
			...
			rowView = inflater.inflate(R.layout.user_profile_micropost_row_layout, parent, false);
