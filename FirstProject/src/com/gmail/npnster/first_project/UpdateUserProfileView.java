...
public class UpdateUserProfileView {
	...
	@InjectView(R.id.update_user_profile_email_id)
	TextView userProfileEmailIdTextView;
	@InjectView(R.id.update_user_profile_name)
	TextView userProfileNameTextView;
	@InjectView(R.id.update_user_profile_password)
	TextView userProfilePasswordTextView;
	@InjectView(R.id.update_user_profile_confirmation_password)
	TextView userProfileConfirmationPasswordTextView;
	@InjectView(R.id.update_user_profile_current_password)
	TextView userProfileCurrentPasswordTextView;
	@InjectView(R.id.update_user_profile_icon)
	ImageView userProfileIconImageView;
	...
	public void initializeView(View rootView) {
		...
		userProfileCurrentPasswordTextView.setOnEditorActionListener(new OnEditorActionListener() {
			...
			public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
				...
				System.out.println(String.format("actionId = %d", actionId));
				if (event != null) {
					System.out.println(String.format("event action = %d", event.getAction()));
				} else {
	...
	public void showErrorsDialog(ArrayList<String> errors) {
		RailsErrorsDialog dialog = new RailsErrorsDialog(getActivity(), errors);

	}

	public void showUpdatedProfileToast() {
